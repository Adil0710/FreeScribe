...
function Footer() {
  return (
    <header className='flex items-center justify-between gap-4 p-3'>
            <a href="https://adil0710.github.io/" target='_blank'><h1 className='font-medium text-sm text-slate-400'>Copyright © Developed By |<span className='text-slate-600 bold hover:text-slate-800 duration-200'> Adil Patel</span></h1></a>
